// png2src_big -- convert PNG file into C++ source code header file.
// the result can be compiled into the sgdm3 executable.
//
// use this version for large png's for which the normal version
// builds a hdr string longer than 64kb and blows up msvc's compiler.
//////////////////////////////////////////////////////////////////
// usage:
//    png2src_big [<png-files>...]
//////////////////////////////////////////////////////////////////
...
int main(int argc, char ** argv)
{
	if (argc < 2)
	{
		fprintf(stderr,"Usage: png2src_big [png/foo.png]\n");
	...
	for (int k=1; k<argc; k++)
	{
		...
		fprintf(fileOut,"const char ga_%s[] = {\n",szVar);
		...
		fprintf(fileOut,"0\n");
		fprintf(fileOut,"};\n");
		fprintf(fileOut,"const char * gsz_%s = ga_%s;\n",szVar,szVar);
